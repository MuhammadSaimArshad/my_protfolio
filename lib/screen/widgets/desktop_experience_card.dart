...
import 'package:my_protfolio/screen/widgets/role_bullet.dart' show RoleBullet;
import 'package:my_protfolio/screen/widgets/tech_bullet.dart' show TechBullet;

class DesktopExperienceCard extends StatelessWidget {
  ...
  const DesktopExperienceCard({
    super.key,
    required this.data,
    this.primaryColor = const Color(0xFF09FBD4), // default green
  });
